...
import kotlinx.android.synthetic.main.layout_tab_food_item.view.*


class FoodTabAdapter(val listener: (View, MyTab, Int) -> Unit) :
    RecyclerView.Adapter<FoodTabAdapter.ProductTabViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductTabViewHolder {
        return ProductTabViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.layout_tab_food_item, parent, false)
        )
    }
